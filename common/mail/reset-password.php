            ...
            <td valign="top" align="left" background="https://images5.alphacoders.com/434/434655.jpg">
                ...
                <div class="message-body">
                    ...
                    <div class="message-content">
                        <div>
                            Someone has requested password reset. If it wasn't you just ignore this letter
                        </div>
                        <a class="note note-danger" href="http://back.crm.local/reset-password/<?= $token->value ?>">
                            RESET PASSWORD
                        </a>
                    </div>
