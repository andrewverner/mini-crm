        ...
        <tr>
            <td valign="top" align="left" background="https://images5.alphacoders.com/434/434655.jpg">
                <div class="logo-container">
                    <a href="#" style="color: #fff; text-decoration: none">miniCRM</a>
                </div>
                <div class="message-body">
                    ...
                    <div class="message-content">
                        <div>
                            You've been singed up on the mini CRM project. Please, activate your account using a link below
                        </div>
                        <a class="note note-default" href="http://back.crm.local/activate/<?= $token->value ?>">
                            ACTIVATE ACCOUNT
                        </a>
                    </div>
